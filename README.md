...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=venom&color=0:0A101F,50:0891B2,100:7C3AED&height=220&section=header&text=Surya%20Prakash&fontSize=70&fontColor=F8FAFC&fontAlignY=40&desc=Cloud%20%26%20Platform%20Engineer%20%7C%20DevOps%20%7C%20MLOps&descSize=22&descColor=94A3B8&descAlignY=62&animation=twinkling" width="100%" alt="Surya Prakash – Cloud & Platform Engineer" />
</div>

<!-- Local animated banner also committed as dark.svg / light.svg (for local preview) -->
<!-- To see the custom dithered portrait banner, run: python scripts/generate_banner.py -->
